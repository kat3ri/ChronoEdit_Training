...
from chronoedit._src.configs.i2v_wan.config import register_optimizer, \
    register_scheduler, \
    register_model, \
    register_callbacks, \
    register_net, \
...
def make_config() -> Config:
    ...
    register_training_and_val_data_no_cosmos()
    register_optimizer()
    register_scheduler()
    register_model()
    register_callbacks()
    ...
    import_all_modules_from_package("chronoedit._src.configs.chronoedit.experiment", reload=True)
    return c
